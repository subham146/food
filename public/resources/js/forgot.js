$(document).ready(function() {
    ...
    function normalizeMessage(text, type) {
        ...
        var map = {
            'Sending OTP...': 'Sending password reset OTP to your email. Please wait...',
            ...
            'Account not Found!': 'No account found for that email address.',
