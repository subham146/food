...
$(document).ready(function() {
  ...
  function normalizeMessage(text, type) {
      ...
      var map = {
          'Sending OTP...': 'Sending OTP to your admin email. Please wait...',
          'OTP has been sent to your email': 'OTP sent successfully. Check your inbox or spam and enter it within 2 minutes.',
          'Admin Login Success': 'OTP verified. Redirecting to the admin panel...',
          ...
          'Invalid credentials': 'Admin credentials are incorrect. Please try again.',
          'Error: Please enter the OTP.': 'Please enter the OTP to continue.',
          'Error: All fields are required.': 'Please fill in both username and password to continue.',
          'Error: Login request failed.': 'Could not start admin login right now. Please try again in a moment.',
