...
PUBLIC_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "public"))
...
def serve_frontend(path):
    full_path = os.path.abspath(os.path.join(PUBLIC_ROOT, path))
    if not full_path.startswith(PUBLIC_ROOT):
        abort(404)
